...
@include('layouts.head' , ['pageTitle' => 'Roles'])

<body class="g-sidenav-show  bg-gray-100" >
  @include('layouts.sidebar' , ['slag' => 8 , 'subSlag' => 82])
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!-- Navbar -->
  @include('layouts.nav' , ['pageTitle' => __('main.roles')])
    <!-- End Navbar -->
                    ...
                    <table class="table align-items-center justify-content-center mb-0">
                      <thead>
                        <tr>
                          ...
                          <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">{{ __('main.description') }}</th>
                          <th></th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center">
                            <button type="button" class="btn btn-success editBtn" value="{{ $role -> id }}"><i class="fas fa-edit"></i></button>
                          <button type="button" class="btn btn-danger deleteBtn" value="{{ $role -> id }}"><i class="far fa-trash-alt"></i></button>
                          </td>
                        </tr>
                        @endforeach
