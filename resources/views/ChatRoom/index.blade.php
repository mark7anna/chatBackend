                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        {{ __('main.img') }}</th>
                      <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        {{ __('main.lock_State') }}</th>
                      <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        {{ __('main.password') }}</th>
                      <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        {{ __('main.subject') }}</th>
                      <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        {{ __('main.room_owner') }}</th>
                      <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        {{ __('main.talkers') }}</th>
                      <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        {{ __('main.miccount') }}</th>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <input type="checkbox" class="form-check" onclick="return false;"
                          style="display: block ; margin:auto" @if($room -> state == 1 ) checked @endif/>
                      </td>
                      ...
                      <td class="text-center">
                        <input type="checkbox" class="form-check" onclick="return false;"
                          style="display: block ; margin:auto" @if($room -> isBlocked == 1 ) checked @endif/>
                      </td>
                      <td class="text-center"> {{ $room -> createdDate }}</td>
                      <td class="align-middle text-center">
                        @if ($state == 1)
                        <a href="{{ route('rooms_disable' , $room -> id) }}">
                          <button type="button" class="btn btn-danger"><i class="fas fa-trash"></i></button>
                        </a> @else
                        <a href="{{ route('rooms_activate' , $room -> id) }}">
