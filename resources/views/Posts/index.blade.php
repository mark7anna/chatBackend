                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <button type="button" class="btn btn-danger deleteBtn" value="{{ $post -> id }}"><i
                            class="far fa-trash-alt"></i></button>
                        <button type="button" class="btn btn-info editBtn" value="{{ $post -> id }}"><i
                            class="far fa-eye"></i></button>
                        @if($post -> accepted == 0)
                        <a type="button" class="btn btn-primary " href="{{ route('acceptPost' , $post -> id) }}"><i
