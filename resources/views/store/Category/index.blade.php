...
@include('layouts.head' , ['pageTitle' => 'Categores'])

<body class="g-sidenav-show  bg-gray-100" >
  @include('layouts.sidebar' , ['slag' => 7 , 'subSlag' => 71])
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!-- Navbar -->
  @include('layouts.nav' , ['pageTitle' => __('main.categories')])
    <!-- End Navbar -->
    <div class="container-fluid py-4" s>
      ...
      @include('store.Category.create')
      @include('store.Category.deleteModal')
