...
@include('layouts.head' , ['pageTitle' => 'Badges'])

<body class="g-sidenav-show  bg-gray-100" >
  @include('layouts.sidebar' , ['slag' => 3 , 'subSlag' => 0])
...
id="createButton" > <i class="fa fa-plus" style="margin-right: 10px"></i>  Add New</button>
                    ...
                    <table class="table align-items-center justify-content-center mb-0">
                      <thead>
                        <tr>
                          ...
                          <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7 ps-2">{{ __('main.badge_icon') }}</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center"> <img src="{{ asset('images/Badges/' . $badge->icon) }}" width="80"/>  </td>
                          <td class="text-center">
                            <button type="button" class="btn btn-success editBtn" value="{{ $badge -> id }}"><i class="fas fa-edit"></i></button>
                          <button type="button" class="btn btn-danger deleteBtn" value="{{ $badge -> id }}"><i class="far fa-trash-alt"></i></button>
                          </td>
                        </tr>
                        @endforeach
      ...
      @include('Badges.create')
      @include('Badges.deleteModal')
