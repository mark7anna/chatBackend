        ...
        public function store(Request $request)
        {
            ...
            if($request -> id == 0){
                ...
                if($request->video_url){
                    $video_url = time() . 'video_url' . '.' . $request->video_url->getClientOriginalExtension();
                    $request->video_url->move(('images/Designs/Video'), $video_url);
                } else {
                    $video_url  = "";
                }

                if($request->audio_url){
                    $audio_url = time() . 'audio_url' . '.' . $request->audio_url->getClientOriginalExtension();
                    $request->audio_url->move(('images/Designs/Audio'), $audio_url);
                } else {
                    $audio_url  = "";
                }
