...
--
-- Host: localhost
-- Generation Time: Jan 03, 2024 at 07:37 PM
...
INSERT INTO `emossions` (`id`, `img`, `icon`, `created_at`, `updated_at`) VALUES
(1, '1703744872.gif', '1704215618icon.jpg', '2023-12-28 04:27:52', '2024-01-02 15:13:38'),
(3, '1704215641.gif', '1704215641icon.png', '2024-01-02 15:14:01', '2024-01-02 15:14:01');
...
INSERT INTO `festival_banners` (`id`, `title`, `type`, `description`, `img`, `room_id`, `start_date`, `duration_in_hour`, `enable`, `accepted`, `created_at`, `updated_at`) VALUES
(1, 'حفلة عيد ميلاد السفير', 1, 'حفلة عيد ميلاد السفير والاحباب والصحاب مدعويين', '1704136212.jpg', 101, '2024-01-10 09:00:00', 1.00, 1, 1, '2024-01-01 17:10:12', '2024-01-01 17:21:29');
...
--
-- Table structure for table `host_agencies`
--
...
CREATE TABLE `host_agencies` (
  ...
  `tag` varchar(255) NOT NULL,
  `user_id` int(11) NOT NULL,
  `monthly_gold_target` decimal(8,2) NOT NULL,
  `details` text NOT NULL,
  `active` int(11) NOT NULL,
  `allow_new_joiners` int(11) NOT NULL,
  `automatic_accept_joiners` int(11) NOT NULL,
  `automatic_accept_exit` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `host_agencies`
--

INSERT INTO `host_agencies` (`id`, `name`, `tag`, `user_id`, `monthly_gold_target`, `details`, `active`, `allow_new_joiners`, `automatic_accept_joiners`, `automatic_accept_exit`, `created_at`, `updated_at`) VALUES
(1, 'JOY', '2024010341', 120045, 1000.00, '', 1, 1, 0, 0, '2024-01-03 16:24:20', '2024-01-03 16:24:20');
...
(26, '2023_12_30_053326_create_gift_transactions_table', 18),
(27, '2024_01_02_182418_create_posts_table', 19),
(28, '2024_01_02_182423_create_tags_table', 19),
(29, '2024_01_02_182431_create_post_tages_table', 19),
(30, '2024_01_02_182439_create_comments_table', 19),
(31, '2024_01_02_182515_create_post_likes_table', 19),
(32, '2024_01_03_104709_create_targets_table', 20),
(33, '2024_01_03_105227_create_host_agencies_table', 20);
...
INSERT INTO `posts` (`id`, `content`, `user_id`, `img`, `auth`, `accepted`, `created_at`, `updated_at`) VALUES
(1, 'السلام عليكم اهل كلوب شات', 1, '', 0, 1, '2024-01-02 19:29:31', '2024-01-02 17:31:46');
...
--
-- Table structure for table `post_tages`
--
...
CREATE TABLE `targets` (
  ...
  `agent_amount` decimal(8,2) NOT NULL,
  `icon` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `targets` (`id`, `order`, `gold`, `dollar_amount`, `agent_amount`, `icon`, `created_at`, `updated_at`) VALUES
(2, '1', 300.00, 15.00, 3.00, '1704301853.png', '2024-01-03 15:10:53', '2024-01-03 15:10:53');
...
(1, 1, 100.00, 140.00, NULL, '2024-01-02 15:29:05');
...
--
-- Indexes for table `host_agencies`
--
ALTER TABLE `host_agencies`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `post_tages`
--
ALTER TABLE `post_tages`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `host_agencies`
--
ALTER TABLE `host_agencies`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `post_tages`
--
ALTER TABLE `post_tages`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
